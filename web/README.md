# 🦌 Open Deep Research Platform Web UI

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

> Originated from Open Source, give back to Open Source.

This is the web UI for the Open Deep Research Platform.

## Quick Start

### Prerequisites

- Open Deep Research Platform API
- Node.js (v22.14.0+)
...
- `NEXT_PUBLIC_API_URL`: The URL of the Open Deep Research Platform API.
...
Open Deep Research Platform Web UI uses `pnpm` as its package manager.
...
```bash
docker build --build-arg NEXT_PUBLIC_API_URL=YOUR_API_URL -t open-deep-research-platform-web .
```
...
docker run -d -t -p 3000:3000 --env-file .env --name open-deep-research-platform-web-app open-deep-research-platform-web

# stop the server
docker stop open-deep-research-platform-web-app
```
...
The Open Deep Research Platform is built upon the foundation of these outstanding projects:
...
These outstanding projects form the backbone of the Open Deep Research Platform and exemplify the transformative power of open source collaboration.
